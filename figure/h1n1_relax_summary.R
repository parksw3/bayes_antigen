...
load("../analysis/h1n1_analysis_relax.rda")
...
ggsave("h1n1_map_relax.pdf", gmap, width=8, height=6)
...
ggsave("h1n1_distance_relax.pdf", gdist, width=8, height=6)

w <- c(rep(1/2, 500), rep(1, 500), rep(1/2, 500), rep(1, 500))
...
gvirus <- ggplot(h1n1_virus_effect) +
	geom_hline(ys2intercept=0, lty=2) +
...
ggsave("h1n1_effect_relax.pdf", gtot, width=6, height=4)

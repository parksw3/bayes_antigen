...
rt <- stanc(file="../stancode/antigen_model_relax_2.stan")
sm <- stan_model(stanc_ret = rt, verbose=FALSE)

H1N1_fit <- sampling(sm, data=H1N1_standata, chain=4, iter=10000, thin=10, seed=101,
					 control=list(max_treedepth = 15))

save("H1N1_fit", "H1N1_mod", "H1N1_standata", file="h1n1_analysis_relax2.rda")
